...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_entertainment_types_id"), "entertainment_types", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_entertainment_types_name"),
        "entertainment_types",
        ["name"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["type_id"], ["entertainment_types.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_entertainments_id"), "entertainments", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_entertainments_message_id"),
        "entertainments",
        ["message_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_entertainments_title"), "entertainments", ["title"], unique=False
    )
    op.create_index(
        op.f("ix_entertainments_type_id"), "entertainments", ["type_id"], unique=False
    )
    op.create_table(
        "questions",
        sa.Column("name", sa.String(length=255), nullable=False),
    ...
    op.create_index(
        op.f("ix_questions_level_id"), "questions", ["level_id"], unique=False
    )
    op.create_index(op.f("ix_questions_name"), "questions", ["name"], unique=True)
    op.create_index(
        op.f("ix_questions_theme_id"), "questions", ["theme_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_user_answers_option_id"), "user_answers", ["option_id"], unique=False
    )
    op.create_index(
